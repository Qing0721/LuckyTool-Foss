...
public class XposedHelper {
    ...
    public static void hookAllMethods(Class<?> packageManagerServiceUtils, String verifySignatures, XC_MethodHook methodHook) {
        try {
    ...
    public static void deoptimizeMethod(Method method) {
        try {
            XposedBridge.class.getDeclaredMethod("deoptimizeMethod", java.lang.reflect.Member.class).invoke(null, method);
        } catch (Throwable e) {
            if (DEBUG) Log.e("CorePatch", "deoptimizing failed", e);
        }
    }
}
